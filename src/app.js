...
var functionButton = document.querySelector(".function-btn");
var trigoButton = document.querySelector(".trigonometry-function");
var second = document.querySelector("#second");
//initialization of screen value
var degreeFlag = false;
var memory = [], i = 0;
// var result: string;
function eventList(e) {
    ...
    switch (chId) {
        ...
        case "sin":
            if (degreeFlag) {
                calcScreen.innerHTML = Math.sin((parseInt(calcScreen.innerHTML) * Math.PI) / 180).toPrecision(2);
            }
            else {
                calcScreen.innerHTML = Math.sin(parseInt(calcScreen.innerHTML)).toPrecision(10);
            }
            break;
        case "cos":
            if (degreeFlag) {
                calcScreen.innerHTML = Math.cos((parseInt(calcScreen.innerHTML) * Math.PI) / 180).toPrecision(2);
            }
            else {
                calcScreen.innerHTML = Math.cos(parseInt(calcScreen.innerHTML)).toPrecision(10);
            }
            break;
        case "tan":
            if (degreeFlag) {
                calcScreen.innerHTML = Math.tan((parseInt(calcScreen.innerHTML) * Math.PI) / 180).toPrecision(2);
            }
            else {
                calcScreen.innerHTML = Math.tan(parseInt(calcScreen.innerHTML)).toPrecision(10);
            }
            break;
        case "round":
